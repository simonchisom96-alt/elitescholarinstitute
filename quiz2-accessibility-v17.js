...
function save(){const ok=write('esi.quiz2.a11y.v17',s);try{document.documentElement.dataset.esiReducedMotion=s.reducedMotion?'1':'0';document.documentElement.dataset.esiLargeText=s.largeText?'1':'0';document.documentElement.dataset.esiContrast=s.highContrast?'1':'0'}catch{};try{window.dispatchEvent(new CustomEvent('esi:a11y-change',{detail:{...s}}))}catch{};return{...s,ok}}
function set(name,value){if(!(name in s))return{ok:false,error:'Unknown accessibility setting'};s[name]=value;return save()}
