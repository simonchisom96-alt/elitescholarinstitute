...
(function(){'use strict';
const CONFIG={
  apiBase:'',realtimeUrl:'',storageUrl:'',aiUrl:'',mediaUrl:'',analyticsUrl:'',notificationUrl:'',quizUrl:'',leaderboardUrl:'',chatUrl:'',statusUrl:'',authUrl:'',configured:false
};
...
window.ESIBackendV30={CONFIG,configure,load,endpoint,ready,publicConfig};load();
})();